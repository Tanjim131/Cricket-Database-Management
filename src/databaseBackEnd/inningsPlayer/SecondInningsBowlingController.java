...
import databaseBackEnd.InsertNewMatchController;
import databaseBackEnd.InsertTournamentController;
...
public class SecondInningsBowlingController implements Initializable{
    @FXML
    ...
    void homePage(ActionEvent event) {
        if(InsertNewMatchController.format.equals("Test")){
            UtilityClass.showDialog(Alert.AlertType.ERROR,"Cannot go to home page");
        } else{
            insertIntoDatabase();
            loadFXML("databaseBackEnd", InsertTournamentController.prevFXML);
        }
    }
    ...
    void nextPage(ActionEvent event) {
        if(InsertNewMatchController.format.equals("Test")){
            ...
            if(result.isPresent() && result.get().getText().equals("Yes")) {
                insertIntoDatabase();
                loadFXML("databaseBackEnd/inningsPlayer", "ThirdInningsBatting");
            }
        } else{
