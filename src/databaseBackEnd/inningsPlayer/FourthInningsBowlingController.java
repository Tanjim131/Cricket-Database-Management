...
import databaseBackEnd.Insert2ndInningsController;
...
public class FourthInningsBowlingController implements Initializable {
    ...
    private void populateComboBox(ComboBox <String> comboBox){
        ...
        try{
            plSqlQuery.getCst().setString(1, Insert2ndInningsController.s_2_InningsID);
    ...
    void finish(ActionEvent event) {
        Optional<ButtonType> result = UtilityClass.showDialog(Alert.AlertType.CONFIRMATION,"Finish Innings")
                    .showAndWait();
